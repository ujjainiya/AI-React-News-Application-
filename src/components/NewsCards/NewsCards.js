...
const infoCards = [
  { color: '#93B5C6', title: 'Latest News', text: 'Give me the latest news' },
  ...
  { color: '#BFA2DB', title: 'News by Terms', info: ' get your news down to specific topic like Bitcoin', text: 'What\'s up with PlayStation 5' },
